    ...
    <div class="row g-5 align-items-center mb-5">
        <div class="col-lg-6" data-aos="fade-right">
            ...
            <div class="d-flex gap-3">
                <a href="<?php echo e(route('items.index')); ?>" class="btn btn-premium">Search Listings</a>
                <a href="<?php echo e(route('contact')); ?>" class="btn btn-premium-outline">Contact Support</a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Monami Sadhu\Music\🏫 Campus Lost & Found Portal – Authentication, CRUD, Search\resources\views\about.blade.php ENDPATH**/ ?>