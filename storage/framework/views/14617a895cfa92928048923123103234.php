...
<head>
    ...
    <title>Reset Password - Campus Lost & Found Portal</title>
            ...
            <div class="col-lg-5 col-md-8 col-sm-10" data-aos="zoom-in">
                ...
                <div class="card glass-card border-0 shadow-lg p-3">
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted-custom mb-4">Update your profile credentials password here.</p>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', $request->email)); ?>" required readonly>
                                </div>
...
unset($__errorArgs, $__bag); ?>" placeholder="••••••••" required autofocus autocomplete="new-password">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <button class="btn btn-premium w-100 py-3"><i class="fa-solid fa-key me-2"></i>Update Password</button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\Users\Monami Sadhu\Music\🏫 Campus Lost & Found Portal – Authentication, CRUD, Search\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>