...
unset($__errorArgs, $__bag); ?>" placeholder="student@campus.edu" value="<?php echo e(old('email')); ?>" required autofocus>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4 text-center">
                            <a href="<?php echo e(route('login')); ?>" class="text-decoration-none text-gradient fw-bold small">Back to Login</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\Users\Monami Sadhu\Music\🏫 Campus Lost & Found Portal – Authentication, CRUD, Search\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>