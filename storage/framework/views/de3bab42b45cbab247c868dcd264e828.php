...
unset($__errorArgs, $__bag); ?>" placeholder="Jane Doe" value="<?php echo e(old('name')); ?>" required autofocus autocomplete="name">
                                </div>
...
unset($__errorArgs, $__bag); ?>" placeholder="jane@campus.edu" value="<?php echo e(old('email')); ?>" required autocomplete="username">
                                </div>
...
unset($__errorArgs, $__bag); ?>" placeholder="••••••••" required autocomplete="new-password">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4 text-center text-muted-custom small">
                            Already registered? <a href="<?php echo e(route('login')); ?>" class="text-decoration-none text-gradient fw-bold">Sign In Here</a>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\Monami Sadhu\Music\🏫 Campus Lost & Found Portal – Authentication, CRUD, Search\resources\views\auth\register.blade.php ENDPATH**/ ?>