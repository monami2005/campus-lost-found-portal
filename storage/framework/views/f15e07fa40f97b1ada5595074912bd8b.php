...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>" class="text-decoration-none text-muted-custom">Dashboard</a></li>
...
<div class="container py-4">
    ...
    <div class="row align-items-center mb-4" data-aos="fade-down">
        ...
        <div class="col-md-4 text-md-end mt-3 mt-md-0">
            <a href="<?php echo e(route('admin.users')); ?>" class="btn btn-premium-outline me-2"><i class="fa-solid fa-users me-2"></i>Users</a>
            <a href="<?php echo e(route('admin.items')); ?>" class="btn btn-premium"><i class="fa-solid fa-boxes-stacked me-2"></i>Listings</a>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3" data-aos="fade-up" data-aos-delay="100">
            <div class="glass-card p-4 rounded-4 text-center">
                ...
                <h3 class="fw-bold text-gradient mb-0"><?php echo e($stats['users']); ?></h3>
            </div>
        </div>
        <div class="col-md-3" data-aos="fade-up" data-aos-delay="200">
            <div class="glass-card p-4 rounded-4 text-center">
                <div class="text-muted-custom fw-semibold small mb-1">Total Items</div>
                <h3 class="fw-bold text-gradient mb-0"><?php echo e($stats['items']); ?></h3>
            </div>
        </div>
        <div class="col-md-3" data-aos="fade-up" data-aos-delay="300">
            <div class="glass-card p-4 rounded-4 text-center">
                <div class="text-muted-custom fw-semibold small mb-1">Total Claims</div>
                <h3 class="fw-bold text-gradient mb-0"><?php echo e($stats['claims']); ?></h3>
            </div>
        </div>
        <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
            <div class="glass-card p-4 rounded-4 text-center">
                <div class="text-muted-custom fw-semibold small mb-1">Pending Reports</div>
                <h3 class="fw-bold text-gradient mb-0"><?php echo e($stats['pending']); ?></h3>
            </div>
        </div>
    </div>
            ...
            <table class="table table-custom align-middle mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $pendingClaims; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $claim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <a href="<?php echo e(route('items.show', $claim->item)); ?>" class="fw-bold text-primary text-decoration-none">
                                    <?php echo e($claim->item->title); ?>

                                </a>
                                <div class="small text-muted-custom"><?php echo e($claim->item->category ? $claim->item->category->name : 'Unknown'); ?> · <?php echo e(ucfirst($claim->item->type)); ?></div>
                            </td>
                            <td>
                                <div class="fw-semibold small"><?php echo e($claim->user->name); ?></div>
                                <div class="small text-muted-custom"><?php echo e($claim->user->email); ?></div>
                            </td>
                            <td style="max-width: 300px;">
                                <div class="small text-muted-custom text-truncate" title="<?php echo e($claim->message); ?>"><?php echo e($claim->message); ?></div>
                            </td>
                            <td class="small text-muted-custom"><?php echo e($claim->created_at->diffForHumans()); ?></td>
                            <td>
                                <div class="d-flex gap-2">
                                    <form action="<?php echo e(route('admin.claims.update', $claim)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Monami Sadhu\Music\🏫 Campus Lost & Found Portal – Authentication, CRUD, Search\resources\views\admin\index.blade.php ENDPATH**/ ?>