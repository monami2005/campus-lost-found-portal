    ...
    <div class="glass-card p-4 p-md-5 rounded-4 mb-4 position-relative overflow-hidden" data-aos="fade-down">
        ...
        <div class="row align-items-center g-4 position-relative" style="z-index: 2;">
            <div class="col-md-8">
                ...
                <h1 class="fw-bold display-6 mb-2">Welcome back, <?php echo e(auth()->user()->name); ?>! 👋</h1>
            ...
            <div class="col-md-4 text-md-end">
                <a href="<?php echo e(route('items.create')); ?>" class="btn btn-premium px-4 py-2 me-2">
                    <i class="fa-solid fa-plus me-2"></i>Report Item
                </a>
                <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-premium-outline px-3 py-2">
    ...
    <div class="row g-4 mb-4">
        <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="glass-card p-4 rounded-4 border-start border-4 border-danger h-100">
                ...
                <h2 class="fw-bold mb-1"><?php echo e($lostItems); ?></h2>
        ...
        <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="glass-card p-4 rounded-4 border-start border-4 border-success h-100">
                ...
                <h2 class="fw-bold mb-1"><?php echo e($foundItems); ?></h2>
        ...
        <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="glass-card p-4 rounded-4 border-start border-4 border-info h-100">
                ...
                <h2 class="fw-bold mb-1"><?php echo e($claimedItems); ?></h2>
        ...
        <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="glass-card p-4 rounded-4 border-start border-4 border-warning h-100">
                ...
                <h2 class="fw-bold mb-1"><?php echo e($pendingItems); ?></h2>
        ...
        <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="glass-card p-4 rounded-4 mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span class="badge bg-success-subtle text-success fw-bold px-3 py-1 rounded-pill"><?php echo e($resolutionRate); ?>%</span>
                </div>
                <div class="progress mb-2" style="height: 12px; border-radius: 50px;">
                    <div class="progress-bar bg-gradient" role="progressbar" style="width: <?php echo e($resolutionRate); ?>%; background: linear-gradient(135deg, var(--primary) 0%, var(--success) 100%);" aria-valuenow="<?php echo e($resolutionRate); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            ...
            <div class="glass-card p-4 rounded-4">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="p-3 rounded-3 bg-body-tertiary mb-2 border border-card d-flex align-items-start gap-3">
                        ...
                        <div>
                            <div class="fw-bold small"><?php echo e($notif->title); ?></div>
                            <div class="text-muted-custom small"><?php echo e($notif->message); ?></div>
                            <div class="text-muted small mt-1"><?php echo e($notif->created_at->diffForHumans()); ?></div>
                        </div>
                    </div>
                        ...
                        <div class="p-3 rounded-3 bg-body-tertiary border border-card d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-muted small">by <?php echo e($act->user->name ?? 'System'); ?></div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Monami Sadhu\Music\🏫 Campus Lost & Found Portal – Authentication, CRUD, Search\resources\views\dashboard\student.blade.php ENDPATH**/ ?>