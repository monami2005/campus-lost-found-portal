<?php $__env->startSection('title', 'Welcome to Campus Lost & Found Portal'); ?>
            ...
            <div class="col-lg-7" data-aos="fade-right">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-premium btn-lg px-4"><i class="fa-solid fa-gauge me-2"></i>Go to Dashboard</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-premium btn-lg px-4"><i class="fa-solid fa-user-plus me-2"></i>Get Started</a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('items.index')); ?>" class="btn btn-premium-outline btn-lg px-4"><i class="fa-solid fa-magnifying-glass me-2"></i>Browse Listings</a>
                </div>
...
<section class="container py-5">
    <div class="row g-4 align-items-center mb-5">
        ...
        <div class="col-md-4 text-md-end" data-aos="fade-left">
            <a href="<?php echo e(route('items.index')); ?>" class="btn btn-premium-outline">View All Listings<i class="fa-solid fa-arrow-right ms-2"></i></a>
        </div>
    </div>
    
    <div class="row g-4">
        <?php $__empty_1 = true; $__currentLoopData = $featuredItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                <div class="card glass-card border-0 h-100 overflow-hidden">
                    <div class="position-relative">
                        ...
                        ?>
                        <img src="<?php echo e(asset('storage/' . $firstImg)); ?>" class="card-img-top" style="height: 220px; object-fit: cover;" alt="<?php echo e($item->title); ?>" loading="lazy">
                        <span class="position-absolute top-3 end-3 badge rounded-pill <?php echo e($item->type === 'lost' ? 'bg-danger' : 'bg-success'); ?>" style="top: 1rem; right: 1rem;">
                            <?php echo e(ucfirst($item->type)); ?>

                        </span>
                    </div>
                    <div class="card-body p-4">
                        <h5 class="fw-bold text-truncate mb-2"><?php echo e($item->title); ?></h5>
                        <p class="text-muted-custom small mb-3"><?php echo e(Str::limit($item->description, 80)); ?></p>
                        
                        <div class="d-flex flex-column gap-2 mb-4">
                            <div class="small text-muted-custom d-flex align-items-center">
                                <i class="fa-solid fa-location-dot text-primary me-2" style="width: 15px;"></i><?php echo e($item->location); ?>

                            </div>
                            <div class="small text-muted-custom d-flex align-items-center">
                                <i class="fa-solid fa-calendar-days text-primary me-2" style="width: 15px;"></i><?php echo e(\Carbon\Carbon::parse($item->date)->format('F d, Y')); ?>

                            </div>
                            <div class="small text-muted-custom d-flex align-items-center">
                                <i class="fa-solid fa-tag text-primary me-2" style="width: 15px;"></i><?php echo e($item->category ? $item->category->name : 'Unknown'); ?>

                            </div>
                        </div>
                        
                        <div class="d-flex justify-content-between align-items-center pt-2 border-top border-card">
                            <span class="badge <?php echo e($item->status === 'pending' ? 'bg-warning text-dark' : ($item->status === 'claimed' ? 'bg-info text-white' : 'bg-secondary text-white')); ?> rounded-pill px-3 py-2 small">
                                <?php echo e(ucfirst($item->status)); ?>

                            </span>
                            <a href="<?php echo e(route('items.show', $item)); ?>" class="btn btn-premium-outline btn-sm px-3">View Details</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Monami Sadhu\Music\🏫 Campus Lost & Found Portal – Authentication, CRUD, Search\resources\views/welcome.blade.php ENDPATH**/ ?>